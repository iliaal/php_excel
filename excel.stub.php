...
class ExcelSheet
{
    ...
    public function colWidth(int $column): float|false {}  // ZPP "l"
    public function rowHeight(int $row): float|false {}  // ZPP "l"
    ...
    public function setDisplayGridlines(bool $value): mixed {}  // ZPP "b"
    ...
    public function isRichStr(int $row, int $col): bool {}  // ZPP "ll"

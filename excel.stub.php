...
class ExcelBook
{
    ...
    public function activeSheet(int $sheet = 0): int|false {}  // ZPP "|l"
    ...
    public function addPictureFromFile(mixed $filename): int|false {}  // ZPP ""
    public function addPictureFromString(bool $data): int|false {}  // ZPP ""
    public function rgbMode(): bool {}  // ZPP ""
    public function setRGBMode(bool $mode): mixed {}  // ZPP "b"
    ...
    public function setRefR1C1(bool $active): mixed {}  // ZPP "b"
    ...
    public function setTemplate(bool $mode): mixed {}  // ZPP "b"
...
class ExcelSheet
{
    ...
    public function readRow(int $row, int $start_col = 0, int $end_column = 0, bool $read_formula = false): array|false {}  // ZPP "l|llb"
    public function readCol(int $column, int $start_row = 0, int $end_row = 0, bool $read_formula = false): array|false {}  // ZPP "l|llb"
    ...
    public function isFormula(int $row, int $column): bool {}  // ZPP ""
    public function isDate(int $row, int $column): bool {}  // ZPP "ll"
    public function insertRow(mixed $row_first, mixed $row_last, mixed $update_named_ranges = null): bool {}  // ZPP ""
    public function insertCol(int $col_first, mixed $col_last, mixed $update_named_ranges = null): bool {}  // ZPP ""
    public function removeRow(int $row_first, mixed $row_last, mixed $update_named_ranges = null): bool {}  // ZPP ""
    public function removeCol(int $col_first, mixed $col_last, mixed $update_named_ranges = null): bool {}  // ZPP ""
    ...
    public function setColWidth(int $column_start, int $column_end, float $width, bool $hidden = false, ?ExcelFormat $format = null): bool {}  // ZPP "lld|bz"
    public function setRowHeight(int $row, float $height, ?ExcelFormat $format = null, ?bool $hidden = null): bool {}  // ZPP "ld|zb"
    ...
    public function horPageBreak(int $row, int $break): bool {}  // ZPP ""
    public function verPageBreak(int $col, int $break): bool {}  // ZPP ""
    ...
    public function setPrintGridlines(mixed $value): mixed {}  // ZPP ""
    public function zoom(): int|false {}  // ZPP ""
    public function zoomPrint(): int|false {}  // ZPP ""
    public function setZoom(mixed $value): mixed {}  // ZPP ""
    public function setZoomPrint(mixed $value): mixed {}  // ZPP ""
    ...
    public function setFooter(mixed $footer, mixed $margin): bool {}  // ZPP ""
    ...
    public function setHCenter(mixed $value): mixed {}  // ZPP ""
    public function setVCenter(mixed $value): mixed {}  // ZPP ""
    ...
    public function setMarginLeft(mixed $value): mixed {}  // ZPP ""
    public function setMarginRight(mixed $value): mixed {}  // ZPP ""
...
class ExcelFormat
{
    ...
    public function borderLeftColor(mixed $color = null): int|false {}  // ZPP ""
    public function borderRightStyle(mixed $style = null): int|false {}  // ZPP ""
    public function borderRightColor(mixed $color = null): int|false {}  // ZPP ""
    public function borderTopStyle(mixed $style = null): int|false {}  // ZPP ""
    public function borderTopColor(mixed $color = null): int|false {}  // ZPP ""
    public function borderBottomStyle(mixed $style = null): int|false {}  // ZPP ""
    public function borderBottomColor(mixed $color = null): int|false {}  // ZPP ""
    public function borderDiagonalStyle(mixed $style = null): int|false {}  // ZPP ""
    public function borderDiagonalColor(mixed $color = null): int|false {}  // ZPP ""
...
class ExcelFont
{
    public function size(int $size = 0): int|false {}  // ZPP "|l"
    public function italics(bool $size = false): bool {}  // ZPP "|b"
    public function strike(bool $strike = false): bool {}  // ZPP "|b"
    public function bold(bool $bold = false): bool {}  // ZPP "|b"
    public function color(int $color = 0): int|false {}  // ZPP "|l"
    public function mode(int $mode = 0): int|false {}  // ZPP "|l"
    public function underline(int $underline_style = 0): int|false {}  // ZPP "|l"
    public function name(string $name = ""): string|false {}  // ZPP "|S"

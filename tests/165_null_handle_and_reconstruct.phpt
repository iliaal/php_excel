...
excel
--DESCRIPTION--
AutoFilter::column / columnByIndex / Sheet::autoFilter wrapped a NULL
...
--FILE--
<?php
// Sheet::autoFilter on XLS (libxl returns a NULL autofilter handle)
...
// columnByIndex() past the end of the column list is a NULL handle.
...
// column() on a degenerate autofilter ref -> NULL handle -> false.

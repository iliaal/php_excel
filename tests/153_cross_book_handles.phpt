...
as Book::addFormat(), Book::addFont(), and RichString::addFont() legitimately
...
// Font from b1 passed straight to b2's RichString addText() -> rejected;
// the template-copy route is addFont(), which copies into b2.
